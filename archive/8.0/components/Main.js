...
class Main extends React.Component {
    ...
    {
	      src: "../static/sponsors/bp.png",
	      thumbnail: "../static/images/sponsors/bp.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/extrahop.png",
	      thumbnail: "../static/images/sponsors/extrahop.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/facebook.png",
	      thumbnail: "../static/images/sponsors/facebook.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/tiffs.png",
	      thumbnail: "../static/images/sponsors/tiffs.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/TECH.png",
	      thumbnail: "../static/images/sponsors/TECH.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/jpmorgan.png",
	      thumbnail: "../static/images/sponsors/jpmorgan.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/capital.png",
	      thumbnail: "../static/images/sponsors/capital.png",
	      thumbnailHeight: 200,
		},
    {
	      src: "../static/sponsors/hcss.png",
	      thumbnail: "../static/images/sponsors/hcss.png",
	      thumbnailHeight: 200,
		},
	];
  ...
  return item;
		...
		return (
          ...
          <span className="introText">
						...
						<span className="bullet"><FontAwesomeIcon icon={users} color="#CCD4FF" /> Attendees join a team (max of 4) to work on a project – typically some <strong>hardware or software</strong> – in an environment designed for creativity.</span>
        ...
        <article
					...
					style={{ display: 'none' }}>
					<h2 className="introTitle">SCHEDULE OF EVENTS</h2>
					<span className="introText">
            <div className="row">
            <div className="col-3">
              <h2 className="normal">Friday</h2>
            ...
            <div className="col-3">
              <h2 className="normal">Saturday</h2>
              <ul className="schedule-day">
          ...
          <Accordion className="demo-container" accordion="true" expanded="false">
				...
				<article
					...
					<div style={{
					 ...
					 overflow: "auto"}}
					>
						<img src="static/sponsors/logos.png" width="100%"/>
						</div>
				</article>
			</div>
		);

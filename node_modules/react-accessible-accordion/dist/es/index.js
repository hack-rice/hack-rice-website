            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    function (accordionStore, itemStore) {
                        ...
                        return React.createElement(AccordionItem, _extends$5({}, _this2.props, {
                            uuid: uuid,
...
var AccordionItemTitleWrapper = function AccordionItemTitleWrapper(props) {
    return React.createElement(
        ...
        function (accordionStore, itemStore) {
            ...
            return React.createElement(AccordionItemTitle, _extends$7({}, props, item, {
...
var AccordionItemBodyWrapper = function AccordionItemBodyWrapper(props) {
    return React.createElement(
        ...
        function (accordionStore, itemStore) {
            ...
            return React.createElement(AccordionItemBody, _extends$9({}, props, item, { accordion: accordion }));
        }
    );
};

...
function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      }, "What if I'm not very experienced?"), "Please bring a student ID so we can verify and register you on-site! You'll also need to bring a computer, whatever software you feel might be necessary for development, sleeping bag, and pillow. We also recommend that you bring power strips for convenience. Teammates are free to share equipment with each other."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 78
        }
...
//# sourceMappingURL=4.b61dc412c5cac6c0c501.hot-update.js.map
...
function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      }, "We are looking for technically advanced solutions to technically challenging problems that make use of hardware and API's. That being said, if you can solve a technically challenging problem with a simple solution, we will be very impressed! Additionally, we would like to emphasize that API's should only be used when necessary."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 40
        }
...
//# sourceMappingURL=4.f2fc5cdfd52bf4807f40.hot-update.js.map
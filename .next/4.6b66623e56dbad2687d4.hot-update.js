...
function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      }, "Judging Criteria"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 39
        }
      }, "We are looking for technically advanced solutions to technically challenging problems that make use of hardware and API's. That being said, if you can solve a technically challenging problem with a simple solution, we will be very impressed! Additionally, we would like to emphasize that ", __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("b", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 39
        }
      }, "API's should only be used when necessary.")), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 40
        }
      }, "We are looking for original ideas or new angles on existing ideas. For example, using an API in a unique way. We know API's work - we want to see if you can do something new and awesome with them!"), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 41
        }
      }, "We are looking for aesthetically pleasing projects with smooth and clear user experience."), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 42
        }
      }, "We are looking for socially good projects that people would use. Additionally, we would like to emphasize that we will extensively check to make sure that your project is one that people can use in the real world and doesn't only work on the cases you demo."), close), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("article", {
        id: "work",
...
//# sourceMappingURL=4.6b66623e56dbad2687d4.hot-update.js.map
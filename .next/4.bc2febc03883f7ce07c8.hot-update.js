...
function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function render() {
      ...
      }, "We are looking for technically advanced solutions to technically challenging problems that make use of hardware and API's. That being said, if you can solve a technically challenging problem with a simple solution, we will be very impressed! Additionally, we would like to emphasize that API's should only be used when necessary."), close), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("article", {
        id: "work",
...
//# sourceMappingURL=4.bc2febc03883f7ce07c8.hot-update.js.map